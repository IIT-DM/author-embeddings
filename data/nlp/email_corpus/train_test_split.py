...
blog_data = pd.read_csv("data/nlp/subreddit_hrs/reddit_crossgenre_as_csv_processed.csv")
blog_train, blog_test = train_test_split_by_author(blog_data)
blog_train.to_csv("data/nlp/subreddit_hrs/reddit_crossgenre_deberta_train.csv", index=False)
blog_test.to_csv("data/nlp/subreddit_hrs/reddit_crossgenre_deberta_test.csv", index=False)
