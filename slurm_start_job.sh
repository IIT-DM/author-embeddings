...
if [[ ! -d "/share/lvegna/anaconda3/envs/$CONDA_ENV_NAME" ]]; then
    ...
    conda activate $CONDA_ENV_NAME
    export LD_LIBRARY_PATH="/share/lvegna/anaconda3/envs/$CONDA_ENV_NAME/lib/"

fi
 
# Running neural network
python /share/lvegna/Repos/author/authorship-embeddings/data/nlp/subreddit_hrs/clean_data.py